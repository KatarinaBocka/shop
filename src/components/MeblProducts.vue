  ...
  <div id="mebl-products">
      ...
      <div class="container px-0">
        <div class="row tab-content">
          <div class="col-lg-4 col-md-6 col-sm-12 col-12" v-for="product in filterMebl" :key="product.id">
            <router-link :to="'/proizvod/' + product.category + '/' + product.name + '/' + product.id" >
            <div class="card">
              <div class="card-head">
                <img :src="product.currentImage" alt="Shoe"  class="product-img primary-thumb">
                <span class="badge">New</span>
              </div>
              <div class="card-body">
                <div class="product-desc">
                  <div class="product-title">{{ product.category }}: <span class="right-part">{{ product.name }}</span></div>
                  <div class="product-caption">Dimenzije: <span class="right-part">{{ product.dimenzije }}</span></div>
                  <div class="product-caption">Mehanizam: <span class="right-part">{{ product.mehanizam }}</span></div>
                  <div class="product-caption">Kutija za posteljinu: <span class="right-part">{{ product.kutijaZaPosteljinu }}</span></div>
                  <div class="product-caption">Punjenje: <span class="right-part">{{ product.punjenje }}</span></div>
                  <span class="product-price">{{ product.price }} USD <br> <span class="old-price">{{ product.oldPrice }} USD</span><br></span>
        ...
        filterMebl(product) {
            ...
            if (subcategory === undefined){
              ...
              console.log("test " + subcategory)
                return this.$store.state.mebl.TapaciraniNamestaj.filter(function(product) {
